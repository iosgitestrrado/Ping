...
- (void)constructAlertCardView {
    ...
    UIImageView* iconImage = [[UIImageView alloc] initWithFrame:CGRectMake(self.view.frame.size.width -((kDefaulInset*2.f)+_iconImageSize.width), (_alertViewHeight - _iconImageSize.height) / 2.f, _iconImageSize.width, _iconImageSize.height)];
    iconImage.contentMode = UIViewContentModeScaleAspectFit;
    iconImage.image = _iconImage;
    [alertView addSubview:iconImage];
    
    UILabel* titleLabel = [UILabel new];
    titleLabel.frame = CGRectMake(kDefaulInset, kDefaulInset, self.view.frame.size.width - ((kDefaulInset*3.f) + _iconImageSize.width), _titleLabelHeight);
    titleLabel.lineBreakMode = NSLineBreakByWordWrapping;
    titleLabel.textAlignment = NSTextAlignmentLeft;
    titleLabel.numberOfLines = 0;
    titleLabel.textColor = _titleLabelTextColor;
    ...
    UILabel* messageLabel = [UILabel new];
    messageLabel.frame = CGRectMake(kDefaulInset, kDefaulInset + _titleLabelHeight + 3.f, self.view.frame.size.width - ((kDefaulInset*3.f) + _iconImageSize.width), _messageLabelHeight);
    messageLabel.lineBreakMode = NSLineBreakByWordWrapping;
    messageLabel.textAlignment = NSTextAlignmentLeft;
    messageLabel.numberOfLines = 0;
    messageLabel.textColor = _messageLabelTextColor;
...
- (void)configureViewForAlertType:(ISAlertType)alertType iconImage:(UIImage*)iconImage {
    ...
    self.messageLabelFont = [UIFont fontWithName:@"Lato-Regular" size:16.0];
