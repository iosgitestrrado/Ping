...
- (void)goToCoachMarkIndexed:(NSUInteger)index {
    ...
    if (self.enableSkipButton && markIndex == 0) {
        btnSkipCoach = [[UIButton alloc] initWithFrame:(CGRect){{(self.frame.size.width/2) -(btnSkipWidth/2), [self yOriginForContinueLabel]}, {btnSkipWidth, 30.0f}}];
