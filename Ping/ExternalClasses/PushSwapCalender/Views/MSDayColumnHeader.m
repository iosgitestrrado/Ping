...
- (void)setDay:(NSDate *)day
{
    ...
    if (!dateFormatter) {
        ...
        dateFormatter.dateFormat = ((UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) ? @"EEE d" : @"EEE dd MMM yyyy");
    }
...
- (void)setCurrentDay:(BOOL)currentDay
{
    ...
    if (currentDay) {
        ...
        self.title.font                         = [UIFont fontWithName:@"Lato-Regular" size:16.0];
      //  self.titleBackground.backgroundColor    = [UIColor colorWithHexString:@"#5A5251"];
    } else {
        self.title.font                         = [UIFont fontWithName:@"Lato-Regular" size:16.0];
        self.title.textColor                    = [UIColor whiteColor];
