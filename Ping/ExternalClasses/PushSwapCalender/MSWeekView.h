...
@interface MSWeekView : UIView <UICollectionViewDataSource, UICollectionViewDelegate,MSCollectionViewDelegateCalendarLayout,UICollectionViewDelegateFlowLayout>
{
    NSArray             * mEvents;
      BOOL reload;
