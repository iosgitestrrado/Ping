...
- (void)viewDidLoad {
    ...
    [self.viewAddressContainer.layer masksToBounds];
      ...
      [[NSUserDefaults standardUserDefaults] setObject:@"viewwiil" forKey:@"viewwiil"];
...
//     [[NSUserDefaults standardUserDefaults] setObject:[NSString stringWithFormat:@"%@ , %@",self.addressLabel.text] forKey:@"demoLoc"];
//     [[NSUserDefaults standardUserDefaults] setObject:[NSString stringWithFormat:@"%f", self.googleMapView.camera.target.latitude] forKey:@"demoLat"];
//     [[NSUserDefaults standardUserDefaults] setObject:[NSString stringWithFormat:@"%f", self.googleMapView.camera.target.longitude] forKey:@"demoLong"];
//
