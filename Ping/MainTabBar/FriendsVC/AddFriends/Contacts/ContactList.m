...
- (void)fetchAllContacts {
    ...
    { //if Contacts.framework is available
        ...
        switch ([CNContactStore authorizationStatusForEntityType:CNEntityTypeContacts])
        {
            ...
            { //Address book status not determined.
                ...
                [contactStore requestAccessForEntityType:CNEntityTypeContacts completionHandler:^(BOOL granted, NSError *error) { //permission Request alert will show here.
                    if (granted)
                    { //if user allow to access a contacts in this app.
    ...
    { //else AddressBook.framework is available below iOS 9
